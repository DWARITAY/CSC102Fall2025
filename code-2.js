...
// this varable will keep track of the current interval
       let intervalID = 0;

    // this funtion will start the image moving around
    function startMove(){
      // create a shortcut/nickname to the image in the HTML
      let image = document.getElementById("./code meme/Screenshot 2025-09-20 at 4.06.44 PM.png");
    ...
    // funtion to stop the image from moving
    function stopMove(){
    ...
    // funtion to randomly generate a number
    function getRandNum(){
